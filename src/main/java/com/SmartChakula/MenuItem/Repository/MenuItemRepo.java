...
public interface MenuItemRepo  extends JpaRepository<MenuItem, Long> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    void insertMenuItem(@Param("uid") String uid, 
    ...
    @Query(value = """
            UPDATE menu_items
            SET name = :name, description = :description, price = :price, image = :image, is_available = :available, updated_at = NOW()
            WHERE uid = :uid
